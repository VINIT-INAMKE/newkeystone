class OutHeader extends HTMLElement {
    ...
    <div class="nav__data">
        <a href="/" class="nav__logo">
            <img src="https://media.discordapp.net/attachments/851837926496796694/1229814106828181654/keystone_logo.png?ex=66310ca3&is=661e97a3&hm=9946e263d94d7ff17492c84153f41643bbd3e95a06fdc7041db2e70c5bb5964a&=&format=webp&quality=lossless"
                alt="" /><img
            ...
            <li class="dropdown__item">
               ...
               <span class="dropdown__title">About Us</span>
                ...
                <ul class="dropdown__list">
                  ...
                  <li>
                  <a href="./about/directordesk.html" class="dropdown__link">
                ...
                <div class="dropdown__container">
                    <div class="dropdown__content">
                        ...
                        <div class="dropdown__group">
                            ...
                            <ul class="dropdown__list">
                                <li>
                                    <a href="./admission/brochure.html" class="dropdown__link">Admission Brochure</a>
                                </li>
                                <li>
                                    <a href="./admission/procedure.html" class="dropdown__link">Admission Procedure</a>
                                </li>

                                <li>
                                    <a href="./admission/notice.html" class="dropdown__link">Admission Notice</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="dropdown__container">
                    <div class="dropdown__content">
                        <div class="dropdown__group">
                            ...
                            <ul class="dropdown__list">
                                <li>
                                    <a href="./FE/about.html" class="dropdown__link">About Department</a>
                                </li>
                                <li>
                                    <a href="./FE/hod.html" class="dropdown__link">From the Desk of HOD</a>
                                </li>
                                <li>
                                    <a href="./FE/faculty.html" class="dropdown__link">Faculty</a>
                                </li>
                                <li>
                                    <a href="./FE/syllabus.html" class="dropdown__link">Syllabus</a>
                                </li>
                                <li>
                                    <a href="./FE/labs.html" class="dropdown__link">Laboratories</a>
                                </li>
                                <li>
                                    <a href="./FE/timetables.html" class="dropdown__link">Timetables</a>
                                </li>
                                <li>
                                    <a href="./FE/association.html" class="dropdown__link">Student Associations</a>
                                </li>
                                <li>
                                    <a href="./FE/studentclubs.html" class="dropdown__link">Student Clubs</a>
                                </li>
                                <li>
                        ...
                        <div class="dropdown__group">
                            ...
                            <ul class="dropdown__list">
                                <li>
                                    <a href="./Comp/about.html" class="dropdown__link">About Department</a>
                                </li>
                                <li>
                                    <a href="./Comp/hod.html" class="dropdown__link">From the Desk of HOD</a>
                                </li>
                                <li>
                                    <a href="./Comp/faculty.html" class="dropdown__link">Faculty</a>
                                </li>
                                <li>
                                    <a href="./Comp/syllabus.html" class="dropdown__link">Syllabus</a>
                                </li>
                                <li>
                                    <a href="./Comp/labs.html" class="dropdown__link">Laboratories</a>
                                </li>
                                <li>
                                    <a href="./Comp/timetables.html" class="dropdown__link">Timetables</a>
                                </li>
                                <li>
                                    <a href="./Comp/association.html" class="dropdown__link">Student Associations</a>
                                </li>
                                <li>
                                    <a href="./Comp/studentclubs.html" class="dropdown__link">Student Clubs</a>
                                </li>
                                <li>
                        ...
                        <div class="dropdown__group">
                            ...
                            <ul class="dropdown__list">
                                <li>
                                    <a href="./ENTC/about.html" class="dropdown__link">About Department</a>
                                </li>
                                <li>
                                    <a href="./ENTC/hod.html" class="dropdown__link">From the Desk of HOD</a>
                                </li>
                                <li>
                                    <a href="./ENTC/faculty.html" class="dropdown__link">Faculty</a>
                                </li>
                                <li>
                                    <a href="./ENTC/syllabus.html" class="dropdown__link">Syllabus</a>
                                </li>
                                <li>
                                    <a href="./ENTC/labs.html" class="dropdown__link">Laboratories</a>
                                </li>
                                <li>
                                    <a href="./ENTC/timetables.html" class="dropdown__link">Timetables</a>
                                </li>
                                <li>
                                    <a href="./ENTC/association.html" class="dropdown__link">Student Associations</a>
                                </li>
                                <li>
                                    <a href="./ENTC/studentclubs.html" class="dropdown__link">Student Clubs</a>
                                </li>
                                <li>
                        ...
                        <div class="dropdown__group">
                            ...
                            <ul class="dropdown__list">
                                <li>
                                    <a href="./Mechanical/about.html" class="dropdown__link">About Department</a>
                                </li>
                                <li>
                                    <a href="./Mechanical/hod.html" class="dropdown__link">From the Desk of HOD</a>
                                </li>
                                <li>
                                    <a href="./Mechanical/faculty.html" class="dropdown__link">Faculty</a>
                                </li>
                                <li>
                                    <a href="./Mechanical/syllabus.html" class="dropdown__link">Syllabus</a>
                                </li>
                                <li>
                                    <a href="./Mechanical/labs.html" class="dropdown__link">Laboratories</a>
                                </li>
                                <li>
                                    <a href="./Mechanical/timetables.html" class="dropdown__link">Timetables</a>
                                </li>
                                <li>
                                    <a href="./Mechanical/association.html" class="dropdown__link">Student
                                        Associations</a>
                                </li>
                                <li>
                                    <a href="./Mechanical/studentclubs.html" class="dropdown__link">Student Clubs</a>
                                </li>
                                <li>
                        ...
                        <div class="dropdown__group">
                            ...
                            <ul class="dropdown__list">
                                <li>
                                    <a href="./AIDS/about.html" class="dropdown__link">About Department</a>
                                </li>
                                <li>
                                    <a href="./AIDS/hod.html" class="dropdown__link">From the Desk of HOD</a>
                                </li>
                                <li>
                                    <a href="./AIDS/faculty.html" class="dropdown__link">Faculty</a>
                                </li>
                                <li>
                                    <a href="./AIDS/syllabus.html" class="dropdown__link">Syllabus</a>
                                </li>
                                <li>
                                    <a href="./AIDS/labs.html" class="dropdown__link">Laboratories</a>
                                </li>
                                <!-- <li>
